...
(function(b) {
      ...
      , h = function() {
        ...
        a.prototype.parent = function() {
            return new a(b(this).map(function() {
                var c = new a(this);
                return c.is(":upper") ? null : b(c.is(":toggle") ? this.parentNode.parentNode : this).closest(".dropdown").find('>[data-toggle="dropdown-submenu"]')[0]
            }),this)
        }
        ;
        ...
        a.prototype.children = function(c) {
            ...
            b(this).each(function() {
                ...
                if (d.is(":root"))
                    ...
                    f = b(this).parent().find(">.dropdown-menu");
                else
                    return;
        ...
        a.prototype.jump = function(c) {
            ...
            if (!this.length)
                return new a([],this);
            var e = this.eq(0);
            e = this.is(":flat") || e.is(":upper") ? e.root().children(this.is(":flat")) : e.parent().children();
        ...
        a.prototype.prop = function(a, e) {
            return arguments.length ? 1 < arguments.length ? (this.props[a] = e,
            this) : "object" == typeof arguments[0] ? (b.extend(this.props, arguments[0]),
            this) : a in this.props ? this.props[a] : null : b.extend({}, this.props)
        }
        ;
        ...
        a.prototype.is = function(a) {
            for (var c = b(this), d = (a || "").split(/(?=[*#.\[:\s])/); a = d.pop(); )
                switch (a) {
                case ":root":
                    if (!c.is(".nav-dropdown"))
                        return !1;
                    break;
                case ":upper":
                    if (!c.parent().parent().is(".nav-dropdown"))
                        return !1;
                    break;
                case ":opened":
                case ":closed":
                    if (":opened" == a != c.parent().hasClass("open"))
                        return !1;
                case ":toggle":
                    if (!c.is('[data-toggle="dropdown-submenu"]'))
                        return !1;
                    break;
                default:
                    if (!this.props[a])
    ...
    f.prototype.toggle = function(a) {
        if (this.disabled || b(this).hasClass("disabled"))
            return !1;
        a = b(this.parentNode);
        ...
        c.className = "dropdown-backdrop",
        b(c).insertBefore(b(this).closest(".nav-dropdown")),
        b(c).on("click", f._clearMenus));
        c = {
            relatedTarget: this
        };
    ...
    f._clearMenus = function(a) {
        ...
        if (3 !== a.which) {
            ...
            if (a.target) {
                if (this === document)
                    if (b(a.target).is("a:not([disabled], .disabled)"))
                        var d = b.Event("collapse.bs.nav-dropdown", {
                ...
                else if (b(a.target).hasClass("dropdown-backdrop") && (g = b(a.target).next(),
                g.is(".nav-dropdown") && f._isCollapsed(g)))
                    return;
                b(a.target).is('[data-toggle="dropdown-submenu"]') ? c = b(a.target.parentNode).parents(".dropdown").find('>[data-toggle="dropdown-submenu"]') : b(".dropdown-backdrop").remove()
            }
            ...
            for (g = 0; g < c.length; g++) {
                ...
                if (b(h).hasClass("open") && ("click" !== a.type || !/input|textarea/i.test(a.target.tagName) || !b.contains(h, a.target))) {
                    ...
                    b(h).trigger(l);
                    l.isDefaultPrevented() || (c[g].setAttribute("aria-expanded", "false"),
                    b(h).removeClass("open").trigger(b.Event("hidden.bs.nav-dropdown", k)))
                }
            }
    ...
    f._dataApiKeydownHandler = function(a) {
        if (!/input|textarea/i.test(a.target.tagName)) {
            ...
            c && (a.preventDefault(),
            a.stopPropagation(),
            a.which == d.ESC ? f._isCollapsed(this) || (a = b(a.target).parents(".dropdown.open").last().find('>[data-toggle="dropdown-submenu"]'),
            f._clearMenus(),
            a.trigger("focus")) : "A" == a.target.tagName && (c = h(a.target),
            c.prop(":flat", f._isCollapsed(c.root())),
            c.is(":flat") ? a.which === d.DOWN || a.which === d.UP ? c[a.which === d.UP ? "prev" : "next"]().focus() : a.which === d.LEFT ? c.is(":opened") ? c.close() : c.parent().close().focus() : a.which === d.RIGHT && c.is(":toggle") && c.open() : c.is(":upper") ? a.which === d.LEFT || a.which === d.RIGHT ? (c[a.which === d.LEFT ? "prev" : "next"]().focus().open(),
            c.is(":toggle") && c.close()) : a.which !== d.DOWN && a.which !== d.UP || !c.is(":toggle") || c.children()[a.which === d.DOWN ? "first" : "last"]().focus() : a.which === d.LEFT ? (a = c.parent(),
            a.is(":upper") ? a.close().prev().focus().open() : a.focus().close()) : a.which === d.RIGHT ? (a = c.children(),
            a.length ? (c.open(),
            a.first().focus()) : c.parents(":upper").close().next().focus().open()) : a.which !== d.DOWN && a.which !== d.UP || c[a.which === d.UP ? "prev" : "next"]().focus()))
        }
    }
    ;
    ...
    b.fn.navDropdown = function(a) {
        return this.each(function() {
            ...
            c || b(this).data("bs.nav-dropdown", c = new f(this));
            if ("string" === typeof a) {
                if (void 0 === c[a])
                    throw Error('No method named "' + a + '"');
                c[a].call(this)
            }
        })
    }
    ...
    b(document).on("keydown.bs.nav-dropdown.data-api", ".nav-dropdown", f._dataApiKeydownHandler).on("collapse.bs.navbar-dropdown", f._clearMenus).on("click.bs.nav-dropdown.data-api", f._clearMenus).on("click.bs.nav-dropdown.data-api", '[data-toggle="dropdown-submenu"]', f.prototype.toggle).on("click.bs.nav-dropdown.data-api", ".dropdown form", function(a) {
        a.stopPropagation()
    });
