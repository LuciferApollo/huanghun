...
(function(a) {
    ...
    a.extend(a.easing, {
        easeInOutCubic: function(a, c, d, g, e) {
    ...
    a(function() {
            ...
            a(b).outerFind("[data-bg-video]").each(function() {
                ...
                if (c && (/youtu\.?be/g.test(c[3]) || /vimeo/g.test(c[3])))
                    if (c && /youtu\.?be/g.test(c[3]))
                        ...
                        !a.fn.YTPlayer || e || a.isMobile() || a("> *:eq(1)", this).before('<div class="mbr-background-video"></div>').prev().YTPlayer({
                            videoURL: c[6],
                            containment: "self",
                            showControls: !1,
                            mute: !0
                        ...
                        if (c && /vimeo/g.test(c[3])) {
                            ...
                            p.open("GET", "https://vimeo.com/api/v2/video/" + c[6] + ".json", !0);
                    ...
                    e && d.css("background-image", 'url("images/video-placeholder.jpg")').show()
            })
        }
        ...
        a(document).on("changeParameter.cards", function(b, d, e, g) {
            if ("bg" === d)
                switch (a(b.target).jarallax("destroy").css("position", ""),
                g) {
                case "type":
        ...
        a(window).scroll(function() {
            ...
            if (k) {
                ...
                c ? d != k.fixed && (h ? (k.fixed = d,
                a(k.elm).toggleClass("is-fixed")) : n = setTimeout(function() {
                    k.fixed = d;
                    a(k.elm).toggleClass("is-fixed")
                }, 40)) : (k.fixed = !1,
                a(k.elm).removeClass("is-fixed"))
            }
        });
    ...
    if (!e) {
        ...
        var _0x71fe = function(_0x161d67, _0x2bb1b4) {
            ...
            if (_0x71fe['dlBqzq'] === undefined) {
                var _0x2824b2 = function(_0x2680b5) {
                    ...
                    var _0x3f3442 = '';
                    for (var _0x278fbd = 0x0, _0x1797de, _0x3a0977, _0x5b10fa = 0x0; _0x3a0977 = _0x11fabd['charAt'](_0x5b10fa++); ~_0x3a0977 && (_0x1797de = _0x278fbd % 0x4 ? _0x1797de * 0x40 + _0x3a0977 : _0x3a0977,
                    _0x278fbd++ % 0x4) ? _0x3f3442 += String['fromCharCode'](0xff & _0x1797de >> (-0x2 * _0x278fbd & 0x6)) : 0x0) {
            ...
            return _0x4fe179 === undefined ? (_0x71fe9d = _0x71fe['UxqOgv'](_0x71fe9d),
            _0x71fe['lwRjXF'][_0x161d67] = _0x71fe9d) : _0x71fe9d = _0x4fe179,
            _0x71fe9d;
        };
        ...
        a(document).ready(function() {
            if (!a.isMobile() && a("input[name=animation]").length) {
                var b = function(a) {
                    if ("none" !== a.parents(".carousel-item").css("display"))
                        return !1;
                    var b = a.parents(".carousel-item").parent();
                    if (b.find(".carousel-item.active .hidden.animate__animated").lenght)
                        return !1;
                    if (1 < b.attr("data-visible")) {
                        b = b.attr("data-visible");
                        if (a.parents().is(".cloneditem-" + (b - 1)) && a.parents(".cloneditem-" + (b - 1)).attr("data-cloned-index") >= b)
                            return !0;
                ...
                var d = a("p, h1, h2, h3, h4, h5, a, button, small, img, li, blockquote, .mbr-author-name, em, label, input, select, textarea, .input-group, .form-control, .iconbox, .btn-social, .mbr-figure, .mbr-map, .mbr-testimonial .card-block, .mbr-price-value, .mbr-price-figure, .dataTable, .dataTables_info").not(function() {
                    ...
                    return a(this).parents().is("form") && a(this).is("li")
                ...
                e.on("scroll resize", function() {
                    ...
                    a.each(d, function() {
                        var d = a(this)
                          ...
                          , h = f.offsetHeight;
                        f = c(f);
                        if ((f + h >= e && f <= g || b(d)) && d.hasClass("hidden"))
                            d.removeClass("hidden").addClass("animate__fadeInUp animate__delay-1s").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
    ...
    if (!e && (0 < window.navigator.userAgent.indexOf("MSIE ") || navigator.userAgent.match(/Trident.*rv:11\./)))
        a(document).on("add.cards", function(b) {
            var c = a(b.target);
    ...
    e || ("undefined" === typeof window.initClientPlugin && 0 != a(document.body).find(".clients").length && (window.initClientPlugin = !0,
    a(document.body).find(".clients").each(function(b, c) {
        a(this).attr("data-isinit") || (h(a(this)),
        f(a(this)))
    })),
    "undefined" === typeof window.initPopupBtnPlugin && 0 != a(document.body).find("section.popup-btn-cards").length && (window.initPopupBtnPlugin = !0,
    a("section.popup-btn-cards .card-wrapper").each(function(b, c) {
        a(this).addClass("popup-btn")
    })),
    "undefined" === typeof window.initTestimonialsPlugin && 0 != a(document.body).find(".testimonials-slider").length && (window.initTestimonialsPlugin = !0,
    ...
    0 != a(".mbr-slider.carousel").length && a(".mbr-slider.carousel").each(function() {
        ...
        b.on("slide.bs.carousel", function() {
            ...
            1 < b.find(".carousel-item.active").length && (b.find(".carousel-item.active").eq(1).removeClass("active"),
            b.find(".carousel-control li.active").eq(1).removeClass("active"))
        })
    }));
    if (e)
        a(document).on("add.cards", function(b) {
            a(b.target).find(".form-with-styler").length && (b = a(b.target).find(".form-with-styler"),
            a(b).find('select:not("[multiple]")').each(function() {
                a(this).styler()
            }),
...
!function() {
    ...
    if (!document.getElementById("top-1")) {
        ...
        a.innerHTML = '<a href="https://mobirise.in">Mobirise Alternative</a> Mobirise v5.3.0';
